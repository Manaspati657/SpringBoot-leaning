...
@Repository("devEmpDAO")
@Profile({"dev","test","default"})  //if we add default in profile if no profile is active then IOC automatically take this profile 
public class DevEmployeeDAOImpl implements IEmployeeDAO {
